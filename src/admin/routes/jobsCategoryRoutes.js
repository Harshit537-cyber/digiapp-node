...
const { createJobsCategory, createJobsSubCategory,getAllJobsCategories, updateJobsCategory, deleteJobsCategory, searchJobsCategories } = require("../controllers/jobsCategoryController");
